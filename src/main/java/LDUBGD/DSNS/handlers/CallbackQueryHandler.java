...
public class CallbackQueryHandler implements Handler<CallbackQuery> {
    ...
    public void choose(CallbackQuery callbackQuery) {
        ...
        if (callbackQuery.getData().equals("CPR-Old")) {
            ...
            editMessageText.setText(dBCPR_Old);
...
// TODO: 14.02.23 Перенесено в БД MessageHandler case "Поділитись розташуванням":
//            if (callbackQuery.getData().equals("Персональний комп'ютер")){
